...
<template>
  <div>
    <a :href="issue.url" class="my-1 truncate block flex-row gap-1 gap-2">
      <svg
        v-if="issue.state === 'open'" class="octicon octicon-issue-opened open" title="Open" aria-label="Open issue"
      ...
      <svg
        v-else class="octicon octicon-issue-closed closed" title="Closed" aria-label="Closed issue"
      ...
      <RelatedIssueTitle class="ml-2 !text-white" :text="issue.title" :title="issue.title" />
      <br>
    </a>
